...
\begin{construction}[Cross product]\label{con:cross-product}
  ...
  For multiplications, we define the result of multiplying $\Delta_{\sigma, c},\Delta_{\tau, d} \cross_{\mathfrak{a}}$ to be $\Delta_{\sigma\tau, c\sigma(d)\, \mathfrak{a}(c,d)}$. For any $r \in F$ and $\Delta_{\sigma, c} \in \cross_{\mathfrak{a}}$, we define $r \cdot \Delta_{\sigma, c}$ to be $\Delta_{\sigma, r\cdot c}$.
  \leanok
...
\begin{lemma}
  The cross product $\cross_{\mathfrak{a}}$ is a ring with the multiplicative unit $\Delta_{\mathsf{id}, \mathfrak{a}(1, 1)}$. The $F$-action on $\cross_{\mathfrak{a}}$ defined by $r \cdot \Delta_{\sigma, c} := \Delta_{\sigma, r\cdot c}$ makes it an $F$-algebra.
  \leanok
...
\begin{proof}
  ...
  \begin{itemize}
    \item Associativity of multiplication. We need to check that $\Delta_{\sigma,a}\left(\Delta_{\tau,b}\Delta_{\rho,c}\right) = \left(\Delta_{\sigma,a}\Delta_{\tau,b}\right)\Delta_{\rho,c}\right)$:
          \[
          \begin{aligned}
            \Delta_{\sigma, a}\left(\Delta_{\tau,b}\Delta_{\rho,c}\right)
            &= \Delta_{\sigma,a}\Delta_{\tau\rho,b\tau(c) \mathfrak{a}(b,c)}\\
            &= \Delta_{\sigma\tau\rho,a\sigma(b)\sigma(\tau(c)) \sigma(\mathfrak{a}(b, c))};\\
            %
            \left(\Delta_{\sigma,a}\Delta_{\tau,b}\right)\Delta_{\rho,c}
            &= \Delta_{\sigma\tau,a\sigma(b)\mathfrak{a}(a,b)}\Delta_{\rho,c}\\
            &= \Delta_{\sigma\tau\rho,a\sigma(b)\mathfrak{a}(a, b)\sigma(\tau(c))\mathfrak{a}(\sigma\tau, \rho)}.
          \end{aligned}
          \]
          Hence it is sufficient to check
          \[
          \sigma(\tau(c))\sigma(\mathfrak{a}(b,c)) =
          \mathfrak{a}(a,b)\sigma(\tau(c))\mathfrak{a}(\sigma\tau, \rho).
          \]
