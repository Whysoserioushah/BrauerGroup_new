...
\begin{construction}
 ...
 \begin{definition}[good representation]\label{def:good-rep}
   For any $X \in \br(F)$, a good representation of $X$ is an $A \in \csa_{F}$ and an $F$-algebra map $\iota : K \hookrightarrow A$ such that $[A]_{\sim_{\br}} = X$ and $\dim_{F}A={\left(\dim_{F}K\right)}^{2}$.
   \leanok
   \lean{GoodRep}
 \end{definition}
