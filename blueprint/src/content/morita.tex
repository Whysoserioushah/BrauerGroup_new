...
\begin{proof}
  Let $M$ be an $R$-module, then the unit $\widetilde{\hat{M}} \cong M$ is given by
  \[
    \begin{aligned}
  ...
  Let $M$ be an $\Mat_{n}(R)$-module, then the counit $\hat{\widetilde{M}}\cong M$ is given by $m \mapsto (\delta_{i0}\cdot m)$. This map is both injective and surjective.
\end{proof}
