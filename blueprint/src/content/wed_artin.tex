...
\begin{lemma}[minimal ideal of simple rings]\label{lemma:min-ideal-simple-ring}
  ...
  a simple $A$-module. \leanok \lean{minimal_ideal_isSimpleModule}
\end{lemma}
\begin{proof}
...
\begin{theorem}[Wedderburn]\label{thm:wed}
  ...
  \leanok \lean{Wedderburn_Artin.aux.equivIdeal}
...
\begin{theorem}[Wedderburn-Artin (Ideal)]
  ...
  \leanok \lean{Wedderburn_Artin_ideal_version} \uses{thm:wed}
\end{theorem}
...
\begin{theorem}[Wedderburn-Artin (Algebra)]
  ...
  that $B \cong \Mat_{n}(S)$. \leanok \lean{Wedderburn_Artin_algebra_version}
\end{theorem}
...
\begin{theorem}[Uniqueness of Wedderburn-Artin theorem] Let $B$ be a
