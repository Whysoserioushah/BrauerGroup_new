\chapter{Wedderburn-Artin Theorem for Simple Rings}\label{chap:wed-artin}

\section{Classification of Simple Rings}\label{sec:wed-artin-proof}
...
\section{Uniqueness of the classification}\label{sec:wed-artin-unique}
...
\begin{theorem}[Uniqueness of Wedderburn-Artin theorem] Let $B$ be a finite-dimensional simple $K$-algebra. Suppose $B$ is isomorphic as $k$-algebras to both $\Mat_{n}(D)$ and $\Mat_{n'}(D')$ where $n, n'$ are non-zero natural numbers and $D, D'$ are $k$-division algebra, then $n = n'$ and $D \cong D'$ as $k$-algebras.\label{thm:wed-artin-unique}
  \leanok
