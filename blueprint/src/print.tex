...
\paragraph{} We apologise for the organisation of the report --- earlier chapters often use results from later chapter. For our defence, we try to categorise all the results by topics and, since this is a formalisation project, we can guarantee the readers that there is no circular reasoning.
