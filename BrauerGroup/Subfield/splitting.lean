...
@[simps!]
noncomputable abbrev toTensorMatrix_toFun_Flinear (A n: Type u) [Ring A] [Algebra F A]
...
noncomputable abbrev toTensorMatrix_toFun_Kliniear (A n: Type u) [Ring A] [Algebra F A]
